...
SOURCES += tas_fixtures/snoopyfixture.cpp \
        game.cpp \
        levels/*.cpp \
        sprites/*.cpp \
        inputhandler.cpp \
...
HEADERS += tas_fixtures/snoopyfixture.h \
    levels/*.h \
    sprites/*.h \
    *.h
...
win32{
QMAKE_POST_LINK += "xcopy /Y /i /e /c $$DESTDIR/tas_noopsy.dll C:/QtSDK/Desktop/Qt/4.7.3/mingw/plugins/tasfixtures/"
}
